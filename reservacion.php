...
if(isset($_GET['btn-signup']))
{
	...
	else
	{
		...
		<script>
			...
			document.location.href='verificacion.php';
		</script>
		<?php
	}
}
...
<head>
	...
	<nav class="barra navbar navbar-default" role="navigation">
		<a href="index.php"><img src="Img/Logo.png" height="40" width="90"></a>
			...
			<center>
				<div class="row">
					...
					<div class="col-md-6 cuartos"><br><br><br>
						...
						<input type="checkbox" name="acepto" checked="on" <?php if(isset($code) && $code == 4){ echo "autofocus"; } ?>>&nbsp;<label>Acepto los <a href="index.php" style="text-shadow: none;" title="Ver términos y condiciones del hotel">Términos y Condiciones del Hotel Las Venturas</a></label><br><br>
